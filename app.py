...
market['marketplace'][0] = "Germany"
market['marketplace'][1] = "Spain"
market['marketplace'][2] = "France"
market['marketplace'][3] = "Italy"
market['marketplace'][4] = "United Kingdom"

import json
# Load existing data
with open('carte.json') as f:
    data = json.load(f)
...
app.layout = html.Div([
    ...
    html.Div(className="box",children=[
        html.Div(className="dataframe",children=[
            ...
            html.Iframe(src="assets/map.html", width="100%", height="600px"),
        ]),
